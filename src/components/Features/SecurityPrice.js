        ...
        return(
            ...
            <div className="container">
                <div className="hosting_title security_title text-center">
                    <h2 className="wow fadeInUp" data-wow-delay="0.2s"><span>Wrap up Packge.</span> Free essentials or ultimate protection?</h2>
                </div>
                            ...
                            this.state.list.map( list => {
                                return(
                                    <div className="pr_list" key={list.id}>
                                        ...
                                        <h5 className="pr_title" data-toggle="tooltip" data-placement="top" title="" data-original-title="Save time by using keyboard shortcuts all across Wrap up">{list.adTitle}</h5>
                                        </div>
