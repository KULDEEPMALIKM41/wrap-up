...
import { signup } from '../services/auth_curd'
                            ...
                            <div className="login_info">
                                ...
                                <form action="#" className="login-form sign-in-form">
                                    ...
                                    <div className="form-group text_box">
                                        ...
                                        <input type="text" placeholder="Company Name" name="company_name" onChange={e => setCompanyName(e.target.value)} />
                                    </div>
                                    <div className="form-group text_box" name="country">
                                        <label className="f_p text_c f_400">Country</label>
                                        <select className="select_country" onChange={e => setCountry(e.target.value)}>
                                    ...
                                    <div className="d-flex justify-content-between align-items-center">
                                        <button type="submit" className="btn_three" onClick={handleSubmit} >Sign Up</button>
                                    </div>
                                </form>
                            </div>
                        </div>
